...
QTP.Open "C:\Program Files\Jenkins\workspace\QTP_Framework\Driver\QTPDriver", TRUE 'Set the QTP test path
 
'Set Result location
Set qtpResultsOpt = CreateObject("QuickTest.RunResultsOptions")
qtpResultsOpt.ResultsLocation = "D:\QTP_Framework\TestResults" 'Set the results location
